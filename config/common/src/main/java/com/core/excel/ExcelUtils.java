...
import com.core.excel.interfaces.*;
...
public class ExcelUtils {
    ...
    public static <E> void export(HttpServletResponse response, String fileName, String sheetName, List<E> list, Class<E> clazz){
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            // 获取字段的 @Width 注解
            Width excelWidth = field.getAnnotation(Width.class);
        ...
        // 设置全局行高度
        Height excelHeight = clazz.getAnnotation(Height.class);
        if(BeanUtil.isNotEmpty(excelHeight)){
            // 设置行高
            writer.setRowHeight(-1,excelHeight.height());
        }
