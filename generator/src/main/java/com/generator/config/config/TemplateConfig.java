 ...
 * the License.
 */
package com.generator.config.config;
...
public class TemplateConfig {
     ...
     */
    private void logger(String value, com.baomidou.mybatisplus.generator.config.TemplateType templateType) {
     ...
     * @since 3.3.2
     */
    public TemplateConfig disable(@NotNull com.baomidou.mybatisplus.generator.config.TemplateType... templateTypes) {
        if (templateTypes != null && templateTypes.length > 0) {
            for (com.baomidou.mybatisplus.generator.config.TemplateType templateType : templateTypes) {
                switch (templateType) {
                    case ENTITY:
                        this.entity = null;
                        this.entityKt = null;
    ...
    public TemplateConfig disable() {
        return disable(com.baomidou.mybatisplus.generator.config.TemplateType.values());
    }
